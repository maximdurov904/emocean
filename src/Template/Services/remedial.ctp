...
<?= $this->element('top_banner', ['img' => 'service_banner2.jpg', 'content' => '<h2 class="mt-sm text-left no-txt-transform bold fs50 green-txt-color mb30 make-centered">REMEDIAL <span class="white-txt-color">WORKS</span></h2>']) ?>
...
<section class="full-img-everytrade remedial-bg"></section>
